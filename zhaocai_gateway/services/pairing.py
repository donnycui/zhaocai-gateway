...
class PairingService:
    ...
    def issue_pairing_token(
        ...
        *,
        ...
        pairing_token = self.store.create_pairing_token(
            device_id=device_id,
    ...
    def register_device(
        ...
        *,
        ...
        token_row = self.store.consume_pairing_token(
        ...
        device = self.store.activate_device_registration(
    ...
    def heartbeat(self, *, sync_token: str) -> dict | None:
        device = self.store.touch_device_heartbeat(
